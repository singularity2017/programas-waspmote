...
snprintf(urlsd,sizeof(urlsd), "http://monitoreo.waposat.com/monitor/abc|123|1|%02u-%02u-%02u-%02u-%02u-%02u|1|%s|2|%s|3|%s|4|%s|5|%s|6|%s",RTC.year,RTC.month,RTC.date,RTC.hour, RTC.minute, RTC.second,float_str_current_turvides);
