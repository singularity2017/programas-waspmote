...
//snprintf(urlsd,sizeof(urlsd), "http://monitoreo.waposat.com/monitor/abc|123|1|%s| año:%02u mes:%02u dia:%02u hora:%02u minuto:%02u segundo:%02u  ",float_str_current_turvides,RTC.year,RTC.month,RTC.date,RTC.hour, RTC.minute, RTC.second);
